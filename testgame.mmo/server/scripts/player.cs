...
{
   filename    = "~/data/sound/sfx/lgtstep_mono_01.ogg";
...
{
   filename    = "~/data/sound/sfx/hvystep_mono_01.ogg";
...
function rpgPlayer::kill(%this, %damageType)
{
...
function rpgPlayer::playDeathAnimation(%this)
{
   if (%this.deathIdx++ > 11)
      %this.deathIdx = 1;
...
function rpgPlayer::playCelAnimation(%this,%anim)
{
...
function rpgPlayer::playDeathCry( %this )
{
   %this.playAudio(0,DeathCrySound);
}

function rpgPlayer::playPain( %this )
{
