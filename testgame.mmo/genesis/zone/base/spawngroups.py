...
mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF2")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF3")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF4")
sg.addSpawnInfo(mob)
...
mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF6")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF7")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF8")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF9")
sg.addSpawnInfo(mob)
...
mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF11")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF12")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF13")
sg.addSpawnInfo(mob)

mob = DBSpawnInfo(spawn="Wolf",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="WOLF14")
sg.addSpawnInfo(mob)
...
auctioneer = DBSpawnInfo(spawn="Auctioneer")
sg = DBSpawnGroup(zone="base",groupName="Auctioneer")
sg.addSpawnInfo(auctioneer)
...
rock = DBSpawnInfo(spawn="Rock",frequency=RPG_FREQ_ALWAYS)
sg = DBSpawnGroup(zone="base",groupName="ROCK")
sg.addSpawnInfo(rock)
