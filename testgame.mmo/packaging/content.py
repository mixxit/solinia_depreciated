#Content definitions for Solinia Online
...
FULL_MUSIC = [
       "01 - Solinia Theme.ogg"
]

FULL_SFX = [
	"sfx/hvystep_mono_01.ogg",
	"sfx/lgtStep_mono_01.ogg"
]
...
FOLDERS = ["./testgame.mmo/data/environment","./testgame.mmo/data/spells","./testgame.mmo/data/spells/SELE","./testgame.mmo/data/skies","./testgame.mmo/data/water","./testgame.mmo/data/ui/icons",
