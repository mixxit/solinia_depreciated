...
if(!isObject(MoMTextEditProfileBlack)) new GuiControlProfile (MoMTextEditProfileBlack)
{
   opaque = false;
   fillColor = "128 128 128 100";
   fillColorHL = "128 128 128";
...
if(!isObject(Damageprofile)) new GuiControlProfile (Damageprofile : GuiDefaultProfile)
{
...
if(!isObject(RPGContentProfile)) new GuiControlProfile (RPGContentProfile)
{
   canKeyFocus = true;
   opaque = true;
   fillColor = "255 255 255";
