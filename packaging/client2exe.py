...
shutil.copy("./Microsoft.VC90.CRT.manifest","%s/%s/windows/bin/Microsoft.VC90.CRT.manifest"%(REPO_FOLDER,OUTPUT_FOLDER))
shutil.copy("./msvcm90.dll","%s/%s/windows/bin/msvcm90.dll"%(REPO_FOLDER,OUTPUT_FOLDER))
shutil.copy("./msvcp90.dll","%s/%s/windows/bin/msvcp90.dll"%(REPO_FOLDER,OUTPUT_FOLDER))
shutil.copy("./msvcr90.dll","%s/%s/windows/bin/msvcr90.dll"%(REPO_FOLDER,OUTPUT_FOLDER))
...
shutil.copy("./Microsoft.VC90.CRT.manifest","./distrib/bin/Microsoft.VC90.CRT.manifest")
shutil.copy("./msvcm90.dll","./distrib/bin/msvcm90.dll")
shutil.copy("./msvcp90.dll","./distrib/bin/msvcp90.dll")
shutil.copy("./msvcr90.dll","./distrib/bin/msvcr90.dll")
