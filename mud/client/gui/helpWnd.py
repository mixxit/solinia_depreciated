...
EULATEXT = """<linkcolor:AAAA00><shadowcolor:000000><shadow:1:1><just:center><lmargin%:2><rmargin%:98><font:Arial Bold:22>Solinia Online ++VERSION++ - Licensing Agreement

<color:FFFFFF><just:left><font:Arial:13>
This Software Licensing Agreement (\\"Agreement\\") is a legal agreement between you and Solinia Online. By installing this Software, by loading or running the Software, by placing or copying the Software onto your hard drive, or by distributing the Software, you agree to be bound by the terms of this Agreement. These are the only terms by which Solinia Online permits copying or use.

<just:center><font:Arial Bold:16>Solinia Online' LICENSE AGREEMENT FOR the Solinia Online ++VERSION++.
<just:left>

General terms:

<font:Arial Bold:15>1. THE SOFTWARE.
<font:Arial:14>The Software licensed under this Agreement is the ++VERSION++ version of the computer program Solinia Online, which consists of executable files, data files, and documentation.

<font:Arial Bold:15>2. GRANT OF LICENSE.
<font:Arial:14>Subject to the terms and conditions contained in this Agreement, Solinia Online hereby grants a non-exclusive license and right to install and use one (1) copy of the Software for your use on either a home, business, or portable computer for the purpose of testing Solinia Online. In addition, the Software has a multi-player capability that allows users to utilize the Software over the Internet. Use of the Software over the Internet is subject to your acceptance of the Agreement. Solinia Online reserves the right to update, modify, or change the Agreement at any time. The Program is licensed, not sold. Your license confers no title or ownership in the Program. You may not modify, translate, disassemble, reverse engineer, decompile, or create derivative works based upon the Software. You also may not in any way redistribute the software.

<font:Arial Bold:15>3. COPYRIGHT.
<font:Arial:14>All title, ownership, and intellectual property rights in and to the Software and any and all copies thereof (including, but not limited to, any titles, computer code, themes, objects, characters, character names, stories, dialog, catch phrases, locations, concepts, artwork, animations, sounds, musical compositions, audio-visual effects, methods of operation, moral rights, any related documentation, and \\"applets\\" incorporated into the Software) are owned by Solinia Online or it's licensors. The Software is protected by the copyright laws of the United States, international copyright treaties and conventions, and other laws. All rights are reserved. The Software contains certain licensed materials, and Solinia Online' licensors may protect their rights in the event of any violation of this Agreement.

<font:Arial Bold:15>4. NO WARRANTY.
<font:Arial:14>THE SOFTWARE IS PROVIDED \\"AS-IS\\". NO WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, ARE MADE AS TO IT OR ANY MEDIUM IT MAY BE ON. Solinia Online WILL PROVIDE NO REMEDY FOR INDIRECT, CONSEQUENTIAL, PUNITIVE OR INCIDENTAL DAMAGES ARISING FROM IT, INCLUDING SUCH FROM NEGLIGENCE, STRICT LIABILITY, OR BREACH OF WARRANTY OR CONTRACT, EVEN AFTER NOTICE OF THE POSSIBILITY OF SUCH DAMAGES.
