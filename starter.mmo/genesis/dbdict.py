...
class DBSpawn(DBDict):
    ...
    def create(self):
        ...
        if self.auctioneer:
            spawn.flags |= RPG_SPAWN_AUCTIONEER
        if self.noCorpse:
...
class DBEffectProto(DBDict):
    ...
    def create(self):
        ...
        if self.illusionModel or self.illusionRace:
            proto.illusion = EffectIllusion(illusionModel = self.illusionModel,illusionAnimation = self.illusionAnimation,illusionTextureSingle = self.illusionTextureSingle,illusionTextureExtra = self.illusionTextureExtra,illusionTextureBody = self.illusionTextureBody,illusionTextureHead = self.illusionTextureHead,illusionTextureLegs = self.illusionTextureLegs,illusionTextureHands = self.illusionTextureHands,illusionTextureFeet = self.illusionTextureFeet,illusionTextureArms = self.illusionTextureArms,illusionSex = self.illusionSex,illusionRace = self.illusionRace,illusionSndProfile = self.illusionSndProfile,illusionSize = self.illusionSize)
